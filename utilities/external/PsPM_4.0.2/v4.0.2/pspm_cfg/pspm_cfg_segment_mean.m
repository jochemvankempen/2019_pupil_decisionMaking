function [segment_mean] = pspm_cfg_segment_mean(job)
% function [segment_mean] = pspm_cfg_segment_mean(job)
%
% Matlabbatch function for pspm_segment_mean
%__________________________________________________________________________
% PsPM 3.1
% (C) 2016 Tobias Moser (University of Zurich)

% $Id: pspm_cfg_segment_mean.m 377 2016-10-31 15:57:10Z tmoser $
% $Rev: 377 $
...
segment_mean.prog = @pspm_cfg_run_segment_mean;
segment_mean.vout = @pspm_cfg_vout_segment_mean;
segment_mean.help = {['This function creates means over extracted data segments ', ...
    '(as extracted in ''Extract segments'').']};

function vout = pspm_cfg_vout_segment_mean(job)
vout = cfg_dep;
