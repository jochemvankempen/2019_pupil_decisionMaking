function contrast = pspm_cfg_contrast1
% Contrast (first level)

% $Id: pspm_cfg_contrast1.m 450 2017-07-03 15:17:02Z tmoser $
% $Rev: 450 $
...
contrast.prog = @pspm_cfg_run_contrast1;
contrast.vout = @pspm_cfg_vout_contrast;
...
function vout = pspm_cfg_vout_contrast(job)
vout = cfg_dep;
